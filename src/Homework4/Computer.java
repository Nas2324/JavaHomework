...
public class Computer {
    ...
    public Computer(String model, int year, double price, boolean isNoteBook, double hardDiskMemory, double freeMemory, String operationSystem) {
    }
    ...
    void useMemory(double memory){
        ...
        if (memory > freeMemory){
            System.out.println("Not enought fre memory");
        }else  {
